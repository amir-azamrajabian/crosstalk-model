...
| Continuous collector current | I_C | 60 | A | At T_C = 25 deg C |
...
| Power-loop resistance | R_circ | 1 | fixed | Ohm |
| Gate resistance | R_g | 20 | 3-70 | Ohm |
| Gate-lead inductance | L_g | 3 | fixed | nH |
| Emitter inductance | L_e | 5 | 3-400 | nH |
| Collector inductance | L_c | 1 | fixed | nH |
| Load current | I_load | 22 | fixed | A |
| V_CE rise time | t_r | 50 | fixed | ns |
| Gate-drive voltage | V_driver | 20 | fixed | V |
...
| Label | Value | Oscilloscope File |
|-------|-------|-------------------|
| R_g,1 | 10 Ohm | Gate_1.CSV |
| R_g,2 | 15 Ohm | Gate_2.CSV |
| R_g,3 | 25 Ohm | Gate_3.CSV |
| R_g,4 | 70 Ohm | Gate_4.CSV |

---

## Si MOSFET: IRFP450 (Extended Model, [TPEL])

The IRFP450 Si MOSFET (International Rectifier) is used in the in-preparation TPEL extension. Its datasheet and all associated code are maintained in a separate private repository. The table below is provided for reference.
...
The voltage-dependent C_gc is modeled as:
...
| Average over V_CE in [25, 400] V | C_gc,avg | approx. 75 | pF |
...
|-------|-----------|-------|----------------|
| [J1] Positive spike | R_g | 10-70 Ohm | < 8% |
| [J1] Negative spike | R_g | 10-70 Ohm | < 12% |
